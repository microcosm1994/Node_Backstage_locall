    ...
    <div class="eago-container">
      <div class="eago-box">
        ...
        <div class="eago-subBox">
          ...
          <p style="color:#323A45;font-weight: 500;height: 50px;line-height: 50px">用户数量</p>
          <div class="number">{{this.getuserCount}}</div>
        </div>
        <div class="eago-subBox">
          <span class="green"><i class="manage"></i></span>
          <p style="color:#323A45;font-weight: 500;height: 50px;line-height: 50px">素材数量</p>
          <div class="number">{{this.getsourceCount}}</div>
        </div>
        <div class="eago-subBox">
    ...
    methods: {
      ...
      monthCount: function () {
        ...
        for (let key in this.monthData) {
          let obj = {}
          obj.name = this.monthData[key].name
          obj.type = 'line'
          obj.stack = '总量'
          obj.data = this.monthData[key].data
          series.push(obj)
        }
      ...
      terraceCount: function () {
        ...
        let array = []
        this.terraceData.forEach(function (value, index, arr) {
          let data = {}
